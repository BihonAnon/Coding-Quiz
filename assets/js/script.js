var newQuestionButtonEl = $('#new-question');
var themeButtonEl = $('#theme-btn');
var lotteryButtonEl = $('#speed-run-btn');
var answerAEl = $('#answer-A');
var answerBEl = $('#answer-B');
var answerCEl = $('#answer-C');
var answerDEl = $('#answer-D');
